...
public:
    ...
    void RegisterMcpTools() {
        ...
        mcp_server.AddTool("self.otto.walk_forward",
                           "行走。steps: 行走步数(1-100); speed: 行走速度(400-1500，数值越小越快，推荐500); "
        ...
        mcp_server.AddTool("self.otto.turn_left",
                           "转身。steps: 转身步数(1-100); speed: 转身速度(400-1500，数值越小越快，推荐500); "
        ...
        mcp_server.AddTool("self.otto.jump",
                           "跳跃。steps: 跳跃次数(1-100); speed: 跳跃速度(400-1500，数值越小越快，推荐700)",
        ...
        mcp_server.AddTool("self.otto.moonwalk",
                           "太空步。steps: 太空步步数(1-100); speed: 速度(400-1500，数值越小越快，推荐700); "
        ...
        mcp_server.AddTool("self.otto.shake_leg",
                           "摇腿。steps: 摇腿次数(1-100); speed: 摇腿速度(400-1500，数值越小越快，推荐700); "
        ...
        if (has_hands_) {
            mcp_server.AddTool(
                "self.otto.hands_up",
                "举手。speed: 举手速度(400-1500，数值越小越快，推荐700); direction: 手部选择(1=左手, "
                "-1=右手, 0=双手)",
            ...
            mcp_server.AddTool(
                ...
                "放手。speed: 放手速度(400-1500，数值越小越快，推荐700); direction: 手部选择(1=左手, "
                "-1=右手, 0=双手)",
                PropertyList({Property("speed", kPropertyTypeInteger, 700, 400, 1500),
                              Property("direction", kPropertyTypeInteger, 1, -1, 1)}),
                [this](const PropertyList& properties) -> ReturnValue {
            ...
            mcp_server.AddTool(
                "self.otto.hand_wave",
                "挥手。speed: 挥手速度(400-1500，数值越小越快，推荐700); direction: 手部选择(1=左手, "
                "-1=右手, 0=双手)",
                PropertyList({Property("speed", kPropertyTypeInteger, 700, 400, 1500),
                              Property("direction", kPropertyTypeInteger, 1, -1, 1)}),
                [this](const PropertyList& properties) -> ReturnValue {
