...
private:
     ...
     * @brief 填充矩形
     */
    static void FillRectangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, bool fill);

    /**
     * @brief 填充直角三角形
     */
    static void FillRectangularTriangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, bool fill);
